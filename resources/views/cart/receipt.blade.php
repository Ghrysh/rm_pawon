...
<body>
    <div class="mobile-container" style="padding: 3rem 1.5rem 2rem 1.5rem; justify-content: center; min-height: 100vh;">
        ...
        <div id="countdown-timer" style="text-align: center; font-size: 1.2rem; font-weight: 700; color: #ffeb3b; margin-bottom: 1.5rem;">
            Batas Waktu: <span id="timerDisplay">--:--</span>
        </div>
    ...
    <script>
        ...
        const maxTime = 15 * 60 * 1000; // 15 minutes in ms
